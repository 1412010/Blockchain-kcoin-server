...
var transactionModelSchema = new mongoose.Schema({
    _hash: {type:String},
    _inputAddress: {type: String}, //địa chỉ gửi (nếu từ hệ thống khác gửi về thì để rỗng do khôg biết địa chỉ)
    ...
    _confirmCode: {type: String},//nếu từ hệ thốn blockchain gửi về thì để trống
